<%-- 
    Document   : c19modified
    Created on : May 22, 2017, 3:33:15 PM
    Author     : welcome
--%>
...
function drop_p1(ev) {
  ...
  var contents = ev.target.t1.value;
  // This goes here:
  var x = CryptoJS.MD5(CryptoJS.enc.Latin1.parse(contents));
...
<body>
    <form action="userlogin.jsp" method="post" onsubmit="generate_pwd()">
    <div align="center">
...
<div style="position:fixed;left:450px ">
    <input type="checkbox" id="r1" /><input type="text" class="rcorners1" id="p1" ondrop="drop_p1(ev)" ondragover="allowDrop(event)" name="corner1" /></div>
<div style=" position:fixed ;right:400px" />
<input type="checkbox" id="r2"/><input type="text"  class="rcorners1" id="p2" ondrop="drop_p2(ev)" ondragover="allowDrop(event)" name="corner2"/>
</div>
</div>
<div align="center"/>
<%
